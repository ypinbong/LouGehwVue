<template>
    ...
    <!-- // *ANCHOR - Modal for editing item details -->
        ...
        centered title="Fill in product details"
        header-class="justify-content-center"
        no-close-on-backdrop
        hide-footer>
            <form action="" method="post">
            <div>
                <img class="mb-3 col-12 text-center" src="undraw_publish_post_vowb.svg" alt="undraw_publish_post_vowb.svg" width="200" height="120">
            </div>
